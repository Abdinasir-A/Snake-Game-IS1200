...
#define TRISDCLR	PIC32_R (0x860C4)   // 0x860C4 is the adress for TRISDCLR
#define TRISDSET	PIC32_R (0x860C8)   // 0x860C8 is the adress for TRISDSET
...
#define T2CONCLR 	PIC32_R (0x0804)    /* Control clear */
#define T2CONSET 	PIC32_R (0x0808)    /* Control set */
#define TMR2  		PIC32_R (0x0810)    /* Timer */
